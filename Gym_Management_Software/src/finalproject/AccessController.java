...
public class AccessController implements Initializable {
    ...
    @FXML
    private void AfterMarket(ActionEvent event)throws IOException {
        callScene("Market.fxml", event);
    }

    @FXML
    private void Supplements(ActionEvent event)throws IOException {
        callScene("Supplements.fxml", event);
    }

    @FXML
    private void GymEquipments(ActionEvent event) throws IOException {
        callScene("GymEquipmentShopNow.fxml", event);
    }

    @FXML
    private void BestSelling(ActionEvent event) throws IOException {
        callScene("BestSelling.fxml", event);
    }
}
