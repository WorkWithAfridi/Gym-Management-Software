...
public class MarketController implements Initializable {
    ...
    @FXML
    private void ShopNowSupplements(ActionEvent event) throws IOException {
        callScene("Supplements.fxml", event);
    }

    @FXML
    private void ShopNowDress(ActionEvent event)throws IOException {
        callScene("Dress.fxml", event);
    }
}
