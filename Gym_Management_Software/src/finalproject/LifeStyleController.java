...
public class LifeStyleController implements Initializable {
    ...
    private void SignUp(ActionEvent event) throws IOException {
        if(EmailA.getText().equals(""))
        {
            EmailA.setText("Please input valid Email Address...");
        }
        else
        {
            callScene("LifeStyleSignUp.fxml", event);
        }
    }

    @FXML
    private void Spa(ActionEvent event) throws IOException {
        callScene("Spa.fxml", event);
    }
